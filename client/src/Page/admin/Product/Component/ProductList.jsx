import { PencilSquare, Trash, PlusLg, Eye, EyeSlash } from "react-bootstrap-icons";
    ...
    <>
      ...
      <div className="card shadow-sm border-0">
        <div className="card-body p-0">
          {products.length === 0 ? (
            <div className="text-center py-5 text-secondary">Chưa có sản phẩm nào</div>
          ) : (
                    ...
                    <tr key={p._id}>
                      ...
                      <td>
                        <div className="d-flex align-items-center gap-3">
                          {p.images[0] && (
                            <img src={p.images[0].url} alt="" className="rounded" style={{ width: 50, height: 50, objectFit: "cover" }} />
                          )}
                          <div>
                      ...
                      <td className="text-center">
                        <span className={`badge ${p.total_variants > 0 ? "bg-success" : "bg-secondary"}`}>
                          {p.total_variants || 0}
                        </span>
                      </td>
                      ...
                      <td className="text-center">
                        {p.is_active ? <Eye className="text-success" /> : <EyeSlash className="text-secondary" />}
                      </td>
                      <td className="text-center">
